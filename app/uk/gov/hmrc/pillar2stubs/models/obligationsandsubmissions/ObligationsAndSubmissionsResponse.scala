...
object ObligationsAndSubmissionsSuccessResponse {
    ...
    ObligationsAndSubmissionsSuccess(
      ...
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
          startDate = LocalDate.of(currentYear, 1, 1),
          endDate = LocalDate.of(currentYear, 12, 31),
          dueDate = LocalDate.of(currentYear, 12, 27),
          underEnquiry = false,
          obligations = Seq(
            Obligation(
              obligationType = ObligationType.UKTR,
  ...
  def uktrDueBeyond60DaysScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def uktrDueAlreadyFulfilledScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def noUktrObligationsScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def uktrOverdueAlreadyFulfilledScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def uktrOverdueFutureDatesScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def noUktrObligationsOverdueScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def uktrIncompleteBothFulfilledScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def uktrIncompleteFutureDueScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def uktrIncompleteOnlyOneTypeNoSubmissionsScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
  ...
  def uktrIncompleteNeitherFulfilledScenario(): ObligationsAndSubmissionsSuccessResponse = ObligationsAndSubmissionsSuccessResponse(
    ObligationsAndSubmissionsSuccess(
      processingDate = now,
      accountingPeriodDetails = Seq(
        AccountingPeriodDetails(
