    ...
    Try {
      ...
      if !accountingPeriods.accountingPeriodValid then {
        ...
        request.headers.get("X-Pillar2-Id").get match {
          ...
          case "XEPLR0000000502" => play.api.mvc.Results.Status(502)(Json.toJson(ObligationsAndSubmissionsSimpleErrorResponse.SAPError))
          ...
          case "XEPLR8888888882" => Ok(Json.toJson(ObligationsAndSubmissionsSuccessResponse.twoActivePeriodsWihDifferentScenarios()))
