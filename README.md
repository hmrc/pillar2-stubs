...
| XEPLR8888888888    | Single active accounting period with no submission          | Returns a single active accounting period with no submission                          |
| XEPLR9999999999    | Multiple active accounting periods with different scenarios | Returns multiple active accounting periods with UKTR, BTN and no submission scenarios |
